...
model_path = os.path.join(settings.BASE_DIR, 'emotion_analysis_app', 'custom_model', 'best_model.h5')
model = load_model(model_path)
# Load Haar Cascade for face detection
face_cascade_path = os.path.join(settings.BASE_DIR, 'emotion_analysis_app', 'custom_model','haarcascade_frontalface_default.xml')
